...
<head>
    ...
    <!-- Page Title  -->
    <title>Pengaduan Masyarakat Cabang Kwangya</title>
    <!-- StyleSheets  -->
...
<body class="nk-body npc-covid has-sidebar has-sidebar-short ui-clean ui-rounder">
    <div class="nk-app-root">
        ...
        <div class="nk-main ">
                    ...
                    <div class="nk-sidebar-body" data-simplebar>
                        <div class="nk-sidebar-content">
                                ...
                                <ul class="nk-menu short-menu">
                                    <li class="nk-menu-item">
                                        <a href="/dashboard" class="nk-menu-link">
                                            ...
                                            <span class="nk-menu-tooltip" title="Dashboard"></span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="/login" class="nk-menu-link">
                                            ...
                                            <span class="nk-menu-tooltip" title="Masuk"></span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="/welcome.php" class="nk-menu-link">
                                            <span class="nk-menu-icon"><em class="icon ni ni-user-list"></em></span>
                                            <span class="nk-menu-text">Daftar</span>
                                            <span class="nk-menu-tooltip" title="Daftar"></span>
                                        </a>
                                    </li>
                                </ul><!-- .nk-menu -->
                            </div><!-- .nk-sidebar-menu -->
                            <div class="nk-sidebar-footer d-none d-md-block">
                                <ul class="nk-menu short-menu">
                                    <li class="nk-menu-item">
                                        <a data-bs-toggle="modal" href="#covid-feedback" class="nk-menu-link">
            ...
            <div class="nk-wrap ">
                ...
                <!-- content @s -->
                <section id="hero">
                    <div class="container text-white mt-5 text-center ">
                        <h2>Layanan Pengaduan Online Masyarakat</h2>
                        <p class="ms-5">Sampaikan laporan Anda langsung kepada instansi pemerintah berwenang</p>
                    </div>
                </section>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#7F88FF" fill-opacity="1" d="M0,160L34.3,176C68.6,192,137,224,206,213.3C274.3,203,343,149,411,112C480,75,549,53,617,74.7C685.7,96,754,160,823,202.7C891.4,245,960,267,1029,256C1097.1,245,1166,203,1234,186.7C1302.9,171,1371,181,1406,186.7L1440,192L1440,0L1405.7,0C1371.4,0,1303,0,1234,0C1165.7,0,1097,0,1029,0C960,0,891,0,823,0C754.3,0,686,0,617,0C548.6,0,480,0,411,0C342.9,0,274,0,206,0C137.1,0,69,0,34,0L0,0Z"></path></svg>
                <!-- content @e -->
                <!-- footer @s -->
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-light justify-content-center py-1">
                    <div class="sub-text">Copyright by <a href="https://softnio.com" target="_blank">Softnio</a></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="justify-between gx-5 mb-3">
                        ...
                        <div>
                            <a href="#" class="btn btn-icon btn-trigger me-n2 mt-n1" data-bs-dismiss="modal" aria-label="Close">
                                <em class="icon ni ni-cross"></em>
                            </a>
                        </div>
                    </div>
                    <ul class="btn-list-vr g-2">
                        ...
                        <li>
                            <a data-bs-dismiss="modal" data-bs-toggle="modal" href="#covid-feedback-form" class="btn btn-round btn-indc btn-lighter"><em class="icon text-primary ni ni-question-alt"></em> <span>Give a compliment</span><em class="indc icon ni ni-chevron-right"></em></a>
                        </li>
                        <li>
                            <a data-bs-dismiss="modal" data-bs-toggle="modal" href="#covid-feedback-form" class="btn btn-round btn-indc btn-lighter"><em class="icon text-primary ni ni-policy"></em> <span>Legal or privacy concern</span><em class="indc icon ni ni-chevron-right"></em></a>
                        </li>
                    </ul>
                </div>
                <div class="modal-footer bg-light justify-content-center py-1">
                    ...
                    <form action="#">
                        ...
                        <div class="align-center justify-between mt-3">
                            ...
                            <ul class="btn-toolbar g-1">
                                <li><a href="#" class="btn btn-light">Go Back</a></li>
    ...
    <script src="assets/js/libs/jqvmap.js?ver=3.1.2"></script>
    <script src="assets/js/chart-covid.js?ver=3.1.2"></script>
</body>
